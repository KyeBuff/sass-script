...
echo "\033[33mPress any key if you have brew installed\033[0m\n";
...
echo "\033[32mNode installed.\033[0m\n";
...
echo "\033[32mGulp packages installed.\033[0m\n";
...
echo "\033[36mYou will need to update the file paths in the gulpfile so that they mirror your file structure.\033[0m\n";

echo "\033[32mRun gulp sass:watch\033[0m\n";
